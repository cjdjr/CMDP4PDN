...
# python transition/collect_data.py --save-path transition/bus141 --length 200000 --scenario case141_3min_final
...
np.save(argv.save_path+'/{}.npy'.format(argv.length),data)